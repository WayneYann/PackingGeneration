...
xMinExtended=$(echo "$xMin-0.1*$xMax+0.1*$zMin" | bc -l)
xMaxExtended=$(echo "$xMax+0.1*$xMax-0.1*$zMin" | bc -l)
yMinExtended=$(echo "$yMin-0.1*$yMax+0.1*$yMin" | bc -l)
yMaxExtended=$(echo "$yMax+0.1*$yMax-0.1*$yMin" | bc -l)
zMinExtended=$(echo "$zMin-0.5*$zMax+0.5*$zMin" | bc -l)
zMaxExtended=$(echo "$zMax+1.0*$zMax-1.0*$zMin" | bc -l)
...
echo "        }" >> caseDicts/snappyHexMeshDict
echo "    }" >> caseDicts/snappyHexMeshDict
echo "    locationInMesh ($xLoc $yLoc $zLoc);" >> caseDicts/snappyHexMeshDict
...
echo "    maxBoundarySkewness 2;" >> caseDicts/snappyHexMeshDict
echo "    maxInternalSkewness 2;" >> caseDicts/snappyHexMeshDict
...
echo "(" >> caseDicts/blockMeshDict
echo "    ($xMin $yMin 	$zMinExtended ) // 0" >> caseDicts/blockMeshDict
echo "    ($xMax $yMin 	$zMinExtended )	// 1" >> caseDicts/blockMeshDict
echo "    ($xMax $yMax 	$zMinExtended ) // 2" >> caseDicts/blockMeshDict
echo "    ($xMin $yMax	$zMinExtended )	// 3" >> caseDicts/blockMeshDict
echo "    ($xMin $yMin 	$zMaxExtended ) // 4" >> caseDicts/blockMeshDict
echo "    ($xMax $yMin 	$zMaxExtended ) // 5" >> caseDicts/blockMeshDict
echo "    ($xMax $yMax 	$zMaxExtended ) // 6" >> caseDicts/blockMeshDict
echo "    ($xMin $yMax	$zMaxExtended ) // 7" >> caseDicts/blockMeshDict
echo ");" >> caseDicts/blockMeshDict
...
echo "		);" >> caseDicts/blockMeshDict
echo "	}" >> caseDicts/blockMeshDict
echo "	inertWall" >> caseDicts/blockMeshDict
echo "	{" >> caseDicts/blockMeshDict
